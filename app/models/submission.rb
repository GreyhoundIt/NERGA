class Submission <  ActiveRecord::Base
  ...
  validates :p1_handicap,:p2_handicap,:p3_handicap,:p4_handicap,:p5_handicap,:p6_handicap,:p7_handicap,:p8_handicap, :format => {:with => /\A\d+(?:\.\d{0,1})?\z/ }, :numericality => {:greater_than => 0, :less_than => 29 }
  belongs_to :user
